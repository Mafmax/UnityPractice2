...
public class AstarMoveController 
{
    ...
    public AstarMoveController(GameObject character, float speed,Canvas toPrint, bool diagonalAdjacent = true, bool Is2D = true,bool isEditableSpeed=true)
    {
        Character = character;
        this.speed = speed;
